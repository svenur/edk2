...
from FmpAuthHeader     import FmpAuthHeaderClass
...
def SignPayloadSignTool (Payload, ToolPath, PfxFile):
    #
    # Create a temporary directory that is automatically deleted
    #
    with tempfile.TemporaryDirectory() as TempDirectoryName:
        #
...
if __name__ == '__main__':
    ...
    parser.add_argument ("--other-public-cert", dest='OpenSslOtherPublicCertFile', type=argparse.FileType('rb'),
                         help="OpemSSL other public certificate filename.")
