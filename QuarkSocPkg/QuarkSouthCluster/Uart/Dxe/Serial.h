...
//
// Quark SoC X1000 Register offsets and bitfields
//
...
#define R_UART_BAUD_HIGH      4        // R/W  Divisor Latch MSB
#define R_UART_IER            4        // R/W  Interrupt Enable Register
#define R_UART_IIR            8        // RO   Interrupt Identification Register
#define R_UART_FCR            8        // WO   FIFO Cotrol Register
#define   B_UART_FCR_FIFOE    BIT0
#define   B_UART_FCR_FIFO64   BIT5
#define R_UART_LCR            12       // R/W  Line Control Register
#define   B_UART_LCR_DLAB     BIT7
#define R_UART_MCR            16       // R/W  Modem Control Register
#define   B_UART_MCR_RTS      BIT1
#define R_UART_LSR            20       // R/W  Line Status Register
#define   B_UART_LSR_RXRDY    BIT0
#define   B_UART_LSR_TXRDY    BIT5
#define   B_UART_LSR_TEMT     BIT6
#define R_UART_MSR            24       // R/W  Modem Status Register
#define   B_UART_MSR_CTS      BIT4
#define   B_UART_MSR_DSR      BIT5
#define R_UART_SCR            28       // R/W  Scratch Pad Register
...
//
#define READ_RBR(DEV)     PciIoMemRead8 (DEV->PciIo, 0, R_UART_RXBUF)
#define READ_DLL(DEV)     PciIoMemRead8 (DEV->PciIo, 0, R_UART_BAUD_LOW)
#define READ_DLM(DEV)     PciIoMemRead8 (DEV->PciIo, 0, R_UART_BAUD_HIGH)
#define READ_IER(DEV)     PciIoMemRead8 (DEV->PciIo, 0, R_UART_IER)
#define READ_IIR(DEV)     PciIoMemRead8 (DEV->PciIo, 0, R_UART_IIR)
#define READ_LCR(DEV)     PciIoMemRead8 (DEV->PciIo, 0, R_UART_LCR)
#define READ_MCR(DEV)     PciIoMemRead8 (DEV->PciIo, 0, R_UART_MCR)
#define READ_LSR(DEV)     PciIoMemRead8 (DEV->PciIo, 0, R_UART_LSR)
#define READ_MSR(DEV)     PciIoMemRead8 (DEV->PciIo, 0, R_UART_MSR)
#define READ_SCR(DEV)     PciIoMemRead8 (DEV->PciIo, 0, R_UART_SCR)

#define WRITE_THR(DEV, D)   PciIoMemWrite8 (DEV->PciIo, 0, R_UART_TXBUF,     D)
#define WRITE_DLL(DEV, D)   PciIoMemWrite8 (DEV->PciIo, 0, R_UART_BAUD_LOW,  D)
#define WRITE_DLM(DEV, D)   PciIoMemWrite8 (DEV->PciIo, 0, R_UART_BAUD_HIGH, D)
#define WRITE_IER(DEV, D)   PciIoMemWrite8 (DEV->PciIo, 0, R_UART_IER,       D)
#define WRITE_FCR(DEV, D)   PciIoMemWrite8 (DEV->PciIo, 0, R_UART_FCR,       D)
#define WRITE_LCR(DEV, D)   PciIoMemWrite8 (DEV->PciIo, 0, R_UART_LCR,       D)
#define WRITE_MCR(DEV, D)   PciIoMemWrite8 (DEV->PciIo, 0, R_UART_MCR,       D)
#define WRITE_LSR(DEV, D)   PciIoMemWrite8 (DEV->PciIo, 0, R_UART_LSR,       D)
#define WRITE_MSR(DEV, D)   PciIoMemWrite8 (DEV->PciIo, 0, R_UART_MSR,       D)
#define WRITE_SCR(DEV, D)   PciIoMemWrite8 (DEV->PciIo, 0, R_UART_SCR,       D)
