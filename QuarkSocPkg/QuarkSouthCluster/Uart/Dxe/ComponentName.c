/** @file
UEFI Component Name and Name2 protocol for PCI serial driver.
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_UNICODE_STRING_TABLE mIohSerialDriverNameTable[] = {
  {
    "eng;en",
    L"Intel Quark SoC X1000 Serial Driver"
  },
  {
    NULL,
    NULL
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR16 mSerialPortName[] = L"Intel Quark SoC X1000 Serial Port # ";
...
{
  mSerialPortName[(sizeof (mSerialPortName) / 2) - 2] = (CHAR16) (L'0' + Instance);
  AddUnicodeString2 (
    "eng",
