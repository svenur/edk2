...
/**
  ...
  @param  ECX  MSR_XEON_PHI_IA32_KERNEL_GSBASE (0xC0000102)
  @param  EAX  Lower 32-bits of MSR value.
  @param  EDX  Upper 32-bits of MSR value.
  ...
  Msr = AsmReadMsr64 (MSR_XEON_PHI_IA32_KERNEL_GSBASE);
  AsmWriteMsr64 (MSR_XEON_PHI_IA32_KERNEL_GSBASE, Msr);
  @endcode
**/
#define MSR_XEON_PHI_IA32_KERNEL_GSBASE          0xC0000102


/**
  Thread. AUXILIARY TSC Signature. (R/W) See Table 35-2.

  @param  ECX  MSR_XEON_PHI_IA32_TSC_AUX (0xC0000103)
  @param  EAX  Lower 32-bits of MSR value.
  @param  EDX  Upper 32-bits of MSR value.
  ...
  Msr = AsmReadMsr64 (MSR_XEON_PHI_IA32_TSC_AUX);
  AsmWriteMsr64 (MSR_XEON_PHI_IA32_TSC_AUX, Msr);
  @endcode
**/
#define MSR_XEON_PHI_IA32_TSC_AUX                0xC0000103
