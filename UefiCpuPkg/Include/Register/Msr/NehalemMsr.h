/** @file
  MSR Defintions for Intel processors based on the Nehalem microarchitecture.
...
/**
  ...
  @param  ECX  MSR_NEHALEM_IA32_KERNEL_GSBASE (0xC0000102)
  @param  EAX  Lower 32-bits of MSR value.
  @param  EDX  Upper 32-bits of MSR value.
  ...
  Msr = AsmReadMsr64 (MSR_NEHALEM_IA32_KERNEL_GSBASE);
  AsmWriteMsr64 (MSR_NEHALEM_IA32_KERNEL_GSBASE, Msr);
  @endcode
**/
#define MSR_NEHALEM_IA32_KERNEL_GSBASE           0xC0000102
