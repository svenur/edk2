/** @file
  MSR Defintions for Intel processors based on the Sandy Bridge microarchitecture.
...
/**
  MSRs. Thread. See Table 35-2.

  @param  ECX  MSR_SANDY_BRIDGE_X2APIC (0x0080283F)
  @param  EAX  Lower 32-bits of MSR value.
  @param  EDX  Upper 32-bits of MSR value.
  ...
  Msr = AsmReadMsr64 (MSR_SANDY_BRIDGE_X2APIC);
  AsmWriteMsr64 (MSR_SANDY_BRIDGE_X2APIC, Msr);
  @endcode
**/
#define MSR_SANDY_BRIDGE_X2APIC                  0x0080283F


/**
  Thread. Swap Target of BASE Address of GS (R/W) See Table 35-2.

  @param  ECX  MSR_SANDY_BRIDGE_IA32_KERNEL_GSBASE (0xC0000102)
  @param  EAX  Lower 32-bits of MSR value.
  @param  EDX  Upper 32-bits of MSR value.
  ...
  Msr = AsmReadMsr64 (MSR_SANDY_BRIDGE_IA32_KERNEL_GSBASE);
  AsmWriteMsr64 (MSR_SANDY_BRIDGE_IA32_KERNEL_GSBASE, Msr);
  @endcode
**/
#define MSR_SANDY_BRIDGE_IA32_KERNEL_GSBASE      0xC0000102
