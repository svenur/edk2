...
/**
  ...
  @param  ECX  MSR_ATOM_IA32_KERNEL_GSBASE (0xC0000102)
  @param  EAX  Lower 32-bits of MSR value.
  @param  EDX  Upper 32-bits of MSR value.
  ...
  Msr = AsmReadMsr64 (MSR_ATOM_IA32_KERNEL_GSBASE);
  AsmWriteMsr64 (MSR_ATOM_IA32_KERNEL_GSBASE, Msr);
  @endcode
**/
#define MSR_ATOM_IA32_KERNEL_GSBASE              0xC0000102
