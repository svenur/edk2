...
/**
  Unique. Swap Target of BASE Address of GS (R/W) See Table 35-2.

  @param  ECX  MSR_CORE2_IA32_KERNEL_GSBASE (0xC0000102)
  @param  EAX  Lower 32-bits of MSR value.
  @param  EDX  Upper 32-bits of MSR value.
  ...
  Msr = AsmReadMsr64 (MSR_CORE2_IA32_KERNEL_GSBASE);
  AsmWriteMsr64 (MSR_CORE2_IA32_KERNEL_GSBASE, Msr);
  @endcode
**/
#define MSR_CORE2_IA32_KERNEL_GSBASE             0xC0000102
